...
#include <vector>
#include <stat/probability/graphical/factor.hpp>
...
class ExactInference {
    public:
        ...
        using Factor     = stat::prob::graphical::Factor;

        ExactInference(std::vector<Factor> factors);
    ...
    private:
        ...
        std::vector<Factor>
        eliminate_variable(std::vector<Factor> factors, std::size_t var) const;
    };
